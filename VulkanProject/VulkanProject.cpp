...
public:
    void run() 
    {
        // Make Window
		m_Window = new Window();
		m_Window->Initialize(utils::WIDTH, utils::HEIGHT, "Vulkan Window");
...
private:
    ...
    void initVulkan() 
    {
        m_VulkanInstance->Initialize("Hello World!");
    ...
    void cleanup() 
    {
        ...
        vkDestroySurfaceKHR(m_VulkanInstance->GetInstance(), surface, nullptr);
    ...
    {
        const auto& vulkanInstance{ m_VulkanInstance->GetInstance() };
    ...
    void createSurface() 
    {
        if (glfwCreateWindowSurface(m_VulkanInstance->GetInstance(), m_Window->GetWindow(), nullptr, &surface) != VK_SUCCESS)
        {
