...
MaterialBuffer::MaterialBuffer(VulkanDevice* pDevice, VulkanCommandPool* pCommandPool) :
...
void MaterialBuffer::CreateMaterialBuffer(std::vector<MaterialGPU> materials)
{
